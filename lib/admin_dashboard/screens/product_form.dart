  ...
  Future<void> _submitForm() async {
    ...
    try {
      ...
      final String endpoint = widget.product == null 
          ...
          : 'http://localhost:8000/edit_product/${widget.product!.pk}/';
      ...
      print('Authorization: Bearer ${request.cookies['token']}');
      print('X-CSRFToken: ${request.cookies['csrftoken']}');

      formData['Authorization'] = 'Bearer ${request.cookies['token'] ?? ''}';
      formData['X-CSRFToken'] = request.cookies['csrftoken'] ?? '';
